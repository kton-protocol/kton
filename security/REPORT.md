...
*The short hashes below name commits in the **archived predecessor repository**, not in this one:
that history did not carry over, so none of them resolves here. They used to be written as links,
which made 70 dead permalinks look like evidence a reader could follow. They are kept as plain
...
|---|---|---|---|---|
| `anchor-bind` | RED | `witness-not-bound-to-record` | `a687723` | `b92c3b3` |
| `anchor-checkpoint` | ORANGE | `witness-not-fully-verified` | `9ea6938` | `9cb7090` |
| `attribution-siblings` | RED | `export-trusts-claimed-keyid` | `24dfc6b` | `fc77c28` |
| `canon-bigint` | RED | `canonicalization` | `24dfc6b` | `1e667f3` |
...
| `when-unvalidated` | ORANGE | `unvalidated-timestamp` | `e5c01e2` | `e8da93c` |
...
- **vulnerable at:** pk `a687723`
- **fixed at (reproduction now fails):** pk `b92c3b3`
...
- **vulnerable at:** pk `9ea6938`
- **fixed at (reproduction now fails):** pk `9cb7090`
...
- **vulnerable at:** pk `24dfc6b`
- **fixed at (reproduction now fails):** pk `fc77c28`
...
- **vulnerable at:** pk `24dfc6b`
- **fixed at (reproduction now fails):** pk `1e667f3`
...
- **vulnerable at:** pk `0aa44b8`
- **fixed at (reproduction now fails):** pk `b625b1f`
...
- **vulnerable at:** pk `9ea6938`
- **fixed at (reproduction now fails):** pk `e92beca`
...
- **vulnerable at:** pk `9ea6938`
- **fixed at (reproduction now fails):** pk `1a8c798`
...
- **vulnerable at:** pk `2e896c8`
- **fixed at (reproduction now fails):** pk `804f052`
...
- **vulnerable at:** pk `a687723`
- **fixed at (reproduction now fails):** pk `8bbdf54`
...
- **vulnerable at:** pk `7df1e70`
- **fixed at (reproduction now fails):** pk `05a94d8`
...
- **vulnerable at:** pk `7df1e70`
- **fixed at (reproduction now fails):** pk `d0f7cf9`
...
- **vulnerable at:** pk `804f052`
- **fixed at (reproduction now fails):** pk `6ff639e`
...
- **vulnerable at:** pk `e5c01e2`
- **fixed at (reproduction now fails):** pk `e8da93c`
- **PoC:** [`attacks/when-unvalidated.sh`](attacks/when-unvalidated.sh)

---
*Generated from the signed graph. The commit hashes above name the archived predecessor repository
and resolve nowhere from here - see the note at the top.*
